...
const TopBarMenu = ({  menu: menuProp }: TopBarProps) => {
    ...
    let menu: ReactNode[] = [
        <Link key="1" href='/' passHref><div className="cursor-pointer hover:text-green-500 hover:scale-125  duration-150">Home</div></Link>,
        <Link key="2" href='/articles' passHref><div className="cursor-pointer hover:text-green-500 hover:scale-125  duration-150">Articles</div></Link>,
        <Link key="3" href='/about' passHref><div className="cursor-pointer hover:text-green-500 hover:scale-125  duration-150">About</div></Link>
    ]
    if (menuProp){
